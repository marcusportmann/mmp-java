 ...
 * 
 */
@WebServiceClient(name = "SampleService", targetNamespace = "http://ws.sample.service.mmp.guru", wsdlLocation = "file:/Volumes/Data/Develop/Projects/mmp-java/src/mmp-sample-wicket-client/src/main/resources/META-INF/wsdl/SampleService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAMPLESERVICE_QNAME = new QName("http://ws.sample.service.mmp.guru", "SampleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Volumes/Data/Develop/Projects/mmp-java/src/mmp-sample-wicket-client/src/main/resources/META-INF/wsdl/SampleService.wsdl");
    ...
    public ISampleService getSampleService() {
        return super.getPort(new QName("http://ws.sample.service.mmp.guru", "SampleService"), ISampleService.class);
    }
    ...
    public ISampleService getSampleService(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.sample.service.mmp.guru", "SampleService"), ISampleService.class, features);
    }
