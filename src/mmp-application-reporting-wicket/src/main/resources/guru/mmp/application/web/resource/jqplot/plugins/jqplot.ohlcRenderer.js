...
(function($) {
     ...
     * 
     * To use this plugin, include the renderer less file in
     * your source:
     * 
     * > <script type="text/javascript" src="plugins/jqplot.ohlcRenderer.less"></script>
     * 
     * You will most likely want to use a date axis renderer
     * for the x axis also, so include the date axis render less file also:
     * 
     * > <script type="text/javascript" src="plugins/jqplot.dateAxisRenderer.less"></script>
     * 
