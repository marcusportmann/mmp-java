...
//  public long next(DataSource dataSource, String type)
//  {
//    return next(dataSource, type, DAOUtil.MMP_DATABASE_SCHEMA);
//  }
//
//  /**
//   * Get the next unique <code>long</code> ID for the entity with the specified type.
//   *
//   * @param schema the schema under which the IDGENERATOR table was created
//   * @param type   the type of entity to retrieve the next ID for
//   *
//   * @return the next unique <code>long</code> ID for the entity with the specified type
//   */
//  @Transactional(propagation = Propagation.REQUIRES_NEW)
//  public long next(DataSource dataSource, String schema, String type)
//  {
...
//   */
//  public UUID nextUUID(DataSource dataSource)
//  {
