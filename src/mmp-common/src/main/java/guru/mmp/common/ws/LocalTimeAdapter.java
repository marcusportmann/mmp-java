...
{
  /**
   * Marshals the <code>java.time.LocalTime</code> value as an ISO8601 string.
   *
   * @param value the value to marshal
   *
   * @return the <code>java.time.LocalTime</code> value as an ISO8601 string
   */
  @Override
  public String marshal(LocalTime value)
  {
    ...
    return ISO8601.fromLocalTime(value);
  }

  /**
   * Unmarshals the ISO8601 string value as a <code>java.time.LocalTime</code>.
   *
   * @param value the ISO8601 string value
   *
   * @return the ISO8601 string value as a <code>java.time.LocalTime</code>
   */
  @Override
  public LocalTime unmarshal(String value)
  {
    ...
    try
    {
      return ISO8601.toLocalTime(value);
    }
    catch (Throwable e)
    {
