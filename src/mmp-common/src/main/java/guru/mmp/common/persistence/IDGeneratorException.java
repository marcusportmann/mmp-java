...
/**
 * The <code>IDGeneratorException</code> exception is thrown to indicate an error condition when
 * working with the <code>IDGenerator</code>.
 *
...
public class IDGeneratorException extends RuntimeException
{
  ...
  /**
   * Constructs a new <code>IDGeneratorException</code> with the specified message.
   *
  ...
  /**
   * Constructs a new <code>IDGeneratorException</code> with the specified cause and a message
