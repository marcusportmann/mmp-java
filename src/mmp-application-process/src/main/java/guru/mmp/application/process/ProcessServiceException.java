...
public class ProcessServiceException extends Exception
{
  ...
  /**
   * Constructs a new <code>ProcessServiceException</code> with <code>null</code> as its
   * message.
   */
  ...
  /**
   * Constructs a new <code>ProcessServiceException</code> with the specified cause and a
