  ...
  extends Exception
{
  ...
  /**
   * Constructs a new <code>CustomerServiceException</code> with <code>null</code> as its
   * message.
   */
  ...
  /**
   * Constructs a new <code>CustomerServiceException</code> with the specified cause and a
