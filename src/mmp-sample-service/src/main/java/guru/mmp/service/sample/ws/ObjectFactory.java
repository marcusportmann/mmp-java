...
public class ObjectFactory {
    ...
    private final static QName _SampleServiceFaultInfo_QNAME = new QName("http://ws.sample.service.mmp.guru", "SampleServiceFaultInfo");
    private final static QName _SampleServiceFaultInfoMessage_QNAME = new QName("http://ws.sample.service.mmp.guru", "Message");
    private final static QName _SampleServiceFaultInfoDetail_QNAME = new QName("http://ws.sample.service.mmp.guru", "Detail");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: guru.mmp.service.sample.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.sample.service.mmp.guru", name = "Message", scope = SampleServiceFaultInfo.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.sample.service.mmp.guru", name = "Detail", scope = SampleServiceFaultInfo.class)
