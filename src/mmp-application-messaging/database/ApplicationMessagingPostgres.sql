-- -------------------------------------------------------------------------------------------------------------------------------------------------------------
--
--      _                _ _           _   _             __  __                           _             ____           _                                  _ 
--     / \   _ __  _ __ | (_) ___ __ _| |_(_) ___  _ __ |  \/  | ___  ___ ___  __ _  __ _(_)_ __   __ _|  _ \ ___  ___| |_ __ _ _ __ ___  ___   ___  __ _| |
--    / _ \ | '_ \| '_ \| | |/ __/ _` | __| |/ _ \| '_ \| |\/| |/ _ \/ __/ __|/ _` |/ _` | | '_ \ / _` | |_) / _ \/ __| __/ _` | '__/ _ \/ __| / __|/ _` | |
--   / ___ \| |_) | |_) | | | (_| (_| | |_| | (_) | | | | |  | |  __/\__ \__ \ (_| | (_| | | | | | (_| |  __/ (_) \__ \ || (_| | | |  __/\__ \_\__ \ (_| | |
--  /_/   \_\ .__/| .__/|_|_|\___\__,_|\__|_|\___/|_| |_|_|  |_|\___||___/___/\__,_|\__, |_|_| |_|\__, |_|   \___/|___/\__\__, |_|  \___||___(_)___/\__, |_|
--          |_|   |_|                                                               |___/         |___/                   |___/                        |_|  
--
-- -------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-- SET PERMISSIONS
-- -------------------------------------------------------------------------------------------------
GRANT ALL ON TABLE MESSAGES TO dbuser;
GRANT ALL ON TABLE MESSAGE_AUDIT_LOG TO dbuser;
GRANT ALL ON TABLE MESSAGE_PARTS TO dbuser;
GRANT ALL ON TABLE ARCHIVED_MESSAGES TO dbuser;
GRANT ALL ON TABLE MESSAGE_TYPES TO dbuser;
GRANT ALL ON TABLE MESSAGE_STATUSES TO dbuser;

GRANT ALL ON TABLE PACKAGES TO dbuser;

GRANT ALL ON TABLE ERROR_REPORTS TO dbuser;
