 ...
 * messaging infrastructure on a mobile device to download the queued messages for the device from
...
public class MessageDownloadResponse
{
    ...
    throws MessagingException
  {
    ...
    // Integer.parseInt(rootElement.getAttributeValue("numberOfMessages"));
