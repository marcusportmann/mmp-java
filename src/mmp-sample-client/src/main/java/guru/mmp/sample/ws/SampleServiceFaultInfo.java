...
@XmlType(name = "SampleServiceFaultInfo", propOrder = {
    "detail",
    "message"
})
    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "Detail", namespace = "http://ws.sample.mmp.guru", type = JAXBElement.class, required = false)
    protected JAXBElement<String> detail;
    @XmlElementRef(name = "Message", namespace = "http://ws.sample.mmp.guru", type = JAXBElement.class, required = false)
