 ...
 *         &lt;element name="Attributes" type="{http://application.model.mmp.guru}ValidationErrorAttribute" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ValidationError implements Serializable
{
    ...
    protected List<ValidationErrorAttribute> attributes;
     ...
     * {@link ValidationErrorAttribute }
     * 
     * 
     */
    public List<ValidationErrorAttribute> getAttributes() {
        if (attributes == null) {
            attributes = new ArrayList<ValidationErrorAttribute>();
        }
