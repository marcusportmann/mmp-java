...
public class ConfigurationNotFoundException extends Exception
{
  ...
  /**
   * Constructs a new <code>ConfigurationNotFoundException</code> with <code>null</code> as its
   * message.
   */
  ...
  /**
   * Constructs a new <code>ConfigurationNotFoundException</code> with the specified cause and a
  ...
  /**
   * Constructs a new <code>ConfigurationNotFoundException</code> with the specified message and
   * cause.
   *
   * @param message The message saved for later retrieval by the <code>getMessage()</code> method.
   * @param cause   The cause saved for later retrieval by the <code>getCause()</code> method.
