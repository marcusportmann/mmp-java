...
public class DuplicateOrganisationException extends Exception
{
  private static final long serialVersionUID = 1000000;

  /**
   * Constructs a new <code>DuplicateOrganisationException</code> with <code>null</code> as its
   * message.
   */
  ...
  /**
   * Constructs a new <code>DuplicateOrganisationException</code> with the specified message.
   *
  ...
  /**
   * Constructs a new <code>DuplicateOrganisationException</code> with the specified cause and a
   ...
   */
  public DuplicateOrganisationException(Throwable cause)
  {
    super(cause);
  }
