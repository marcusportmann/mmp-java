...
public enum OrganisationStatus
{
   ...
   *
   * @param code the numeric code value codeentifying the organisation status
   *
  ...
  /**
   * Returns the numeric codeentifier for the organisation status.
   *
   * @return the numeric codeentifier for the organisation status
   */
  public int code()
  {
    return code;
