...
/**
 * The <code>ApplicationConfigurationException</code> exception is thrown to indicate
 * an error condition when working with the Spring application configuration.
 *
...
public class ApplicationConfigurationException extends RuntimeException
{
  ...
  /**
   * Constructs a new <code>ApplicationConfigurationException</code> with
  ...
  /**
   * Constructs a new <code>ApplicationConfigurationException</code> with the
   * specified message.
   *
