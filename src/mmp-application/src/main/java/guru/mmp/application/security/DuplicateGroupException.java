...
public class DuplicateGroupException extends RuntimeException
{
  ...
  /**
   * Constructs a new <code>DuplicateGroupException</code> with <code>null</code> as its
   * message.
   */
  ...
  /**
   * Constructs a new <code>DuplicateGroupException</code> with the specified message.
   *
  ...
  /**
   * Constructs a new <code>DuplicateGroupException</code> with the specified cause and a
  ...
  /**
   * Constructs a new <code>DuplicateGroupException</code> with the specified message and cause.
   *
   * @param message The message saved for later retrieval by the <code>getMessage()</code> method.
   * @param cause   The cause saved for later retrieval by the <code>getCause()</code> method.
   *                (A <code>null</code> value is permitted if the cause is nonexistent or unknown)
