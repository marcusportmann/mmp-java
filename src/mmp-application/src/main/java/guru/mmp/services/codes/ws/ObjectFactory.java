...
public class ObjectFactory {
    ...
    private final static QName _CodesServiceFaultInfo_QNAME = new QName("http://ws.codes.services.mmp.guru", "CodesServiceFaultInfo");
    private final static QName _CodesServiceFaultInfoMessage_QNAME = new QName("http://ws.codes.services.mmp.guru", "Message");
    private final static QName _CodesServiceFaultInfoDetail_QNAME = new QName("http://ws.codes.services.mmp.guru", "Detail");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.codes.services.mmp.guru", name = "Message", scope = CodesServiceFaultInfo.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.codes.services.mmp.guru", name = "Detail", scope = CodesServiceFaultInfo.class)
