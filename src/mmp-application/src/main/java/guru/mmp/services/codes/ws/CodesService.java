 ...
 */
@WebServiceClient(name = "CodesService", targetNamespace = "http://ws.codes.services.mmp.guru",
...
public class CodesService extends Service
{
  ...
  private final static QName CODESSERVICE_QNAME = new QName("http://ws.codes.services.mmp.guru",
    "CodesService");
  ...
  static
  {
    ...
    {
      url = new URL(
          "file:/Volumes/Data/Develop/MMP/mmp-java/src/mmp-application/src/main/resources/META-INF/wsdl/CodesService.wsdl");
    }
  ...
  /**
   * @return returns ICodesService
   */
  @WebEndpoint(name = "CodesService")
  public ICodesService getCodesService()
  {
    return super.getPort(new QName("http://ws.codes.services.mmp.guru", "CodesService"),
        ICodesService.class);
  }
