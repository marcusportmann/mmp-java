...
public class ObjectFactory
{
  ...
  private final static QName _CodesServiceFaultInfoDetail_QNAME = new QName(
    "http://ws.codes.service.mmp.guru", "Detail");

  private final static QName _CodesServiceFaultInfoMessage_QNAME = new QName(
    "http://ws.codes.service.mmp.guru", "Message");

  private final static QName _CodesServiceFaultInfo_QNAME = new QName(
    "http://ws.codes.service.mmp.guru", "CodesServiceFaultInfo");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived
   * classes for package: guru.mmp.service.codes.ws
   */
   ...
   */
  @XmlElementDecl(namespace = "http://ws.codes.service.mmp.guru", name = "Detail", scope =
    CodesServiceFaultInfo.class)
   ...
   * Create an instance of {@link JAXBElement }{@code <}{@link String }{@code >}}
   */
  @XmlElementDecl(namespace = "http://ws.codes.service.mmp.guru", name = "Message", scope =
    CodesServiceFaultInfo.class)
