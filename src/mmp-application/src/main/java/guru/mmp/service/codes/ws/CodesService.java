 ...
 *
 */
@WebServiceClient(name = "CodesService", targetNamespace = "http://ws.codes.service.mmp.guru",
    wsdlLocation = "file:/Volumes/Data/Develop/Projects/mmp-java/src/mmp-application/src/main/resources/META-INF/wsdl/CodesService.wsdl")
public class CodesService extends Service
{
  private final static QName CODESSERVICE_QNAME = new QName("http://ws.codes.service.mmp.guru",
      "CodesService");
  ...
  static
  {
    ...
    {
      url = new URL(
          "file:/Volumes/Data/Develop/Projects/mmp-java/src/mmp-application/src/main/resources/META-INF/wsdl/CodesService.wsdl");
    }
  ...
  {
    return super.getPort(new QName("http://ws.codes.service.mmp.guru", "CodesService"),
        ICodesService.class);
  }
