...
COMMENT ON COLUMN MMP.PROCESS_INSTANCES.STATE
...
CREATE TABLE MMP.PROCESS_INSTANCE_EVENTS (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT MMP_PROCESS_INSTANCE_EVENTS_PROCESS_FK FOREIGN KEY (PROCESS_ID) REFERENCES MMP.PROCESSES(ID)
);

CREATE INDEX MMP_PROCESS_INSTANCE_EVENTS_PROCESS_IX
...
COMMENT ON COLUMN MMP.PROCESS_INSTANCE_EVENTS.PROCESS_ID
