...
CREATE TABLE MMP.USER_DIRECTORY_TYPES (
  ...
  ADMINISTRATION_CLASS  VARCHAR(4000) NOT NULL,
...
CREATE TABLE MMP.MESSAGE_PARTS (
  ...
  MSG_USERNAME         VARCHAR(4000) NOT NULL,
  ...
  MSG_DATA_HASH        VARCHAR(4000),
  MSG_ENCRYPTION_IV    VARCHAR(4000) NOT NULL,
  MSG_CHECKSUM         VARCHAR(4000) NOT NULL,
  LOCK_NAME            VARCHAR(4000),
  DATA                 BLOB,
...
CREATE TABLE MMP.CUSTOMER_ADDRESSES (
  ...
  LINE_1       VARCHAR(4000) NOT NULL,
  LINE_2       VARCHAR(4000) DEFAULT '',
  LINE_3       VARCHAR(4000) DEFAULT '',
  CITY         VARCHAR(4000) NOT NULL,
  SUBDIVISION  VARCHAR(4000) DEFAULT '',
  CODE         VARCHAR(4000) NOT NULL,
...
INSERT INTO MMP.INTERNAL_USERS (ID, USER_DIRECTORY_ID, USERNAME, PASSWORD, FIRST_NAME, LAST_NAME, PHONE, MOBILE, EMAIL, PASSWORD_ATTEMPTS, PASSWORD_EXPIRY) VALUES
  ('b2bbf431-4af8-4104-b96c-d33b5f66d1e4', '4ef18395-423a-4df6-b7d7-6bcdd85956e4', 'Administrator', 'GVE/3J2k+3KkoF62aRdUjTyQ/5TVQZ4fI2PuqJ3+4d0=', 'Administrator', '', '', '', '', null, null);
