...
DROP TABLE IF EXISTS MMP.USER_DIRECTORY_PARAMETERS CASCADE;
...
CREATE TABLE MMP.USER_DIRECTORY_PARAMETERS (
  ID                 BIGINT NOT NULL,
  ...
  PRIMARY KEY (ID),
  CONSTRAINT MMP_USER_DIRECTORY_PARAMETERS_USER_DIRECTORY_FK FOREIGN KEY (USER_DIRECTORY_ID) REFERENCES MMP.USER_DIRECTORIES(ID) ON DELETE CASCADE
);

CREATE INDEX MMP_USER_DIRECTORY_PARAMETERS_USER_DIRECTORY_ID_IX
  ON MMP.USER_DIRECTORY_PARAMETERS
  (USER_DIRECTORY_ID);

COMMENT ON COLUMN MMP.USER_DIRECTORY_PARAMETERS.ID
  IS 'The unique ID for the user directory parameter';

COMMENT ON COLUMN MMP.USER_DIRECTORY_PARAMETERS.USER_DIRECTORY_ID
  IS 'The unique ID for the user directory the user directory parameter is associated with';

COMMENT ON COLUMN MMP.USER_DIRECTORY_PARAMETERS.NAME
  IS 'The name of the user directory parameter';

COMMENT ON COLUMN MMP.USER_DIRECTORY_PARAMETERS.VALUE
  IS 'The value for the user directory parameter';
...
INSERT INTO MMP.IDGENERATOR (NAME, CURRENT) VALUES
  ('Application.UserDirectoryParameterId', 100000);
INSERT INTO MMP.IDGENERATOR (NAME, CURRENT) VALUES
...
INSERT INTO MMP.INTERNAL_USERS (ID, USER_DIRECTORY_ID, USERNAME, PASSWORD, TITLE, FIRST_NAMES, LAST_NAME, PHONE, FAX,
  ...
  (1, 1, 'Administrator', 'GVE/3J2k+3KkoF62aRdUjTyQ/5TVQZ4fI2PuqJ3+4d0=', '', '', '', '', '', '', '', null, null,
   'Administrator');
INSERT INTO MMP.INTERNAL_USERS (ID, USER_DIRECTORY_ID, USERNAME, PASSWORD, TITLE, FIRST_NAMES, LAST_NAME, PHONE, FAX,
  MOBILE, EMAIL, PASSWORD_ATTEMPTS, PASSWORD_EXPIRY, DESCRIPTION) VALUES
  (2, 1, 'test', 'GVE/3J2k+3KkoF62aRdUjTyQ/5TVQZ4fI2PuqJ3+4d0=', '', '', '', '', '', '', '', null, null,
   'Test User');
...
GRANT ALL ON TABLE MMP.USER_DIRECTORY_PARAMETERS TO dbuser;
