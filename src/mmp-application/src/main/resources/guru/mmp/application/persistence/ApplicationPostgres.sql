...
CREATE UNIQUE INDEX MMP_USERS_USERNAME_IX
  ON MMP.USERS
  (USERNAME);
...
CREATE UNIQUE INDEX MMP_EXTERNAL_USERS_USERNAME_IX
...
CREATE TABLE MMP.PASSWORD_HISTORY (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT MMP_PASSWORD_HISTORY_USER_FK FOREIGN KEY (USER_ID) REFERENCES MMP.USERS(ID) ON DELETE CASCADE
);

CREATE INDEX MMP_PASSWORD_HISTORY_USER_ID_IX
  ON MMP.PASSWORD_HISTORY
  (USER_ID);

CREATE INDEX MMP_PASSWORD_HISTORY_CHANGED_IX
  ON MMP.PASSWORD_HISTORY
  (CHANGED);
...
CREATE UNIQUE INDEX MMP_GROUPS_GROUPNAME_IX
  ON MMP.GROUPS
  (GROUPNAME);
...
CREATE UNIQUE INDEX MMP_EXTERNAL_GROUPS_GROUPNAME_IX
...
CREATE TABLE MMP.USER_GROUP_MAP (
  ...
  CONSTRAINT MMP_USER_GROUP_MAP_GROUP_FK FOREIGN KEY (GROUP_ID) REFERENCES MMP.GROUPS(ID) ON DELETE CASCADE,
  CONSTRAINT MMP_USER_GROUP_MAP_USER_FK FOREIGN KEY (USER_ID) REFERENCES MMP.USERS(ID) ON DELETE CASCADE,
  CONSTRAINT MMP_USER_GROUP_MAP_ORGANISATION_FK FOREIGN KEY (ORGANISATION_ID) REFERENCES MMP.ORGANISATIONS(ID) ON DELETE CASCADE
);

CREATE INDEX MMP_USER_GROUP_MAP_GROUP_ID_IX
  ON MMP.USER_GROUP_MAP
  (GROUP_ID);

CREATE INDEX MMP_USER_GROUP_MAP_USER_ID_IX
  ON MMP.USER_GROUP_MAP
  (USER_ID);

CREATE INDEX MMP_USER_GROUP_MAP_ORGANISATION_ID_IX
  ON MMP.USER_GROUP_MAP
  (ORGANISATION_ID);
...
CREATE TABLE MMP.USER_ORGANISATION_MAP (
  ...
  CONSTRAINT MMP_USER_ORGANISATION_MAP_USER_FK FOREIGN KEY (USER_ID) REFERENCES MMP.USERS(ID) ON DELETE CASCADE,
  CONSTRAINT MMP_USER_ORGANISATION_MAP_ORGANISATION_FK FOREIGN KEY (ORGANISATION_ID) REFERENCES MMP.ORGANISATIONS(ID) ON DELETE CASCADE
);

CREATE INDEX MMP_USER_ORGANISATION_MAP_USER_ID_IX
  ON MMP.USER_ORGANISATION_MAP
  (USER_ID);

CREATE INDEX MMP_USER_ORGANISATION_MAP_ORGANISATION_ID_IX
  ON MMP.USER_ORGANISATION_MAP
  (ORGANISATION_ID);
...
CREATE UNIQUE INDEX MMP_FUNCTION_TEMPLATES_CODE_IX
...
CREATE TABLE MMP.FUNCTION_USER_MAP (
  ...
  CONSTRAINT MMP_FUNCTION_USER_MAP_USER_FK FOREIGN KEY (USER_ID) REFERENCES MMP.USERS(ID) ON DELETE CASCADE,
  CONSTRAINT MMP_FUNCTION_USER_MAP_FUNCTION_FK FOREIGN KEY (FUNCTION_ID) REFERENCES MMP.FUNCTIONS(ID) ON DELETE CASCADE,
  CONSTRAINT MMP_FUNCTION_USER_MAP_ORGANISATION_FK FOREIGN KEY (ORGANISATION_ID) REFERENCES MMP.ORGANISATIONS(ID) ON DELETE CASCADE
);

CREATE INDEX MMP_FUNCTION_USER_MAP_USER_ID_IX
  ON MMP.FUNCTION_USER_MAP
  (USER_ID);
  
CREATE INDEX MMP_FUNCTION_USER_MAP_FUNCTION_ID_IX
  ON MMP.FUNCTION_USER_MAP
  (FUNCTION_ID);   

CREATE INDEX MMP_FUNCTION_USER_MAP_ORGANISATION_ID_IX
  ON MMP.FUNCTION_USER_MAP
  (ORGANISATION_ID);
...
CREATE TABLE MMP.EXTERNAL_FUNCTION_USER_MAP (
  ...
  PRIMARY KEY (USER_ID, FUNCTION_ID, ORGANISATION_ID),
  CONSTRAINT MMP_EXTERNAL_FUNCTION_USER_MAP_USER_FK FOREIGN KEY (USER_ID) REFERENCES MMP.EXTERNAL_USERS(ID) ON DELETE CASCADE,
  CONSTRAINT MMP_EXTERNAL_FUNCTION_USER_MAP_FUNCTION_FK FOREIGN KEY (FUNCTION_ID) REFERENCES MMP.FUNCTIONS(ID) ON DELETE CASCADE,
  CONSTRAINT MMP_EXTERNAL_FUNCTION_USER_MAP_ORGANISATION_FK FOREIGN KEY (ORGANISATION_ID) REFERENCES MMP.ORGANISATIONS(ID) ON DELETE CASCADE
);

CREATE INDEX MMP_EXTERNAL_FUNCTION_USER_MAP_USER_ID_IX
  ON MMP.EXTERNAL_FUNCTION_USER_MAP
  (USER_ID);
  
CREATE INDEX MMP_EXTERNAL_FUNCTION_USER_MAP_FUNCTION_ID_IX
  ON MMP.EXTERNAL_FUNCTION_USER_MAP
  (FUNCTION_ID);

CREATE INDEX MMP_EXTERNAL_FUNCTION_USER_MAP_ORGANISATION_ID_IX
  ON MMP.EXTERNAL_FUNCTION_USER_MAP
  (ORGANISATION_ID);
...
CREATE TABLE MMP.FUNCTION_GROUP_MAP (
  ...
  CONSTRAINT MMP_FUNCTION_GROUP_MAP_GROUP_FK FOREIGN KEY (GROUP_ID) REFERENCES MMP.GROUPS(ID) ON DELETE CASCADE,
  CONSTRAINT MMP_FUNCTION_GROUP_MAP_FUNCTION_FK FOREIGN KEY (FUNCTION_ID) REFERENCES MMP.FUNCTIONS(ID) ON DELETE CASCADE
);

CREATE INDEX MMP_FUNCTION_GROUP_MAP_GROUP_ID_IX
  ON MMP.FUNCTION_GROUP_MAP
  (GROUP_ID);

CREATE INDEX MMP_FUNCTION_GROUP_MAP_FUNCTION_ID_IX
  ON MMP.FUNCTION_GROUP_MAP
  (FUNCTION_ID);  
...
CREATE TABLE MMP.EXTERNAL_FUNCTION_GROUP_MAP (
  ...
  PRIMARY KEY (GROUP_ID, FUNCTION_ID),
  CONSTRAINT MMP_EXTERNAL_FUNCTION_GROUP_MAP_GROUP_FK FOREIGN KEY (GROUP_ID) REFERENCES MMP.EXTERNAL_GROUPS(ID) ON DELETE CASCADE,
  CONSTRAINT MMP_EXTERNAL_FUNCTION_GROUP_MAP_FUNCTION_FK FOREIGN KEY (FUNCTION_ID) REFERENCES MMP.FUNCTIONS(ID) ON DELETE CASCADE
);

CREATE INDEX MMP_EXTERNAL_FUNCTION_GROUP_MAP_GROUP_ID_IX
  ON MMP.EXTERNAL_FUNCTION_GROUP_MAP
  (GROUP_ID);

CREATE INDEX MMP_EXTERNAL_FUNCTION_GROUP_MAP_FUNCTION_ID_IX
  ON MMP.EXTERNAL_FUNCTION_GROUP_MAP
  (FUNCTION_ID);
...
CREATE TABLE MMP.FUNCTION_TEMPLATE_MAP (
  ...
  CONSTRAINT MMP_FUNCTION_TEMPLATE_MAP_FUNC_FK FOREIGN KEY (FUNCTION_ID) REFERENCES MMP.FUNCTIONS(ID) ON DELETE CASCADE,
  CONSTRAINT MMP_FUNCTION_TEMPLATE_MAP_TMPL_FK FOREIGN KEY (TEMPLATE_ID) REFERENCES MMP.FUNCTION_TEMPLATES(ID) ON DELETE CASCADE
);

CREATE INDEX MMP_FUNCTION_TEMPLATE_MAP_FUNCTION_ID_IX
  ON MMP.FUNCTION_TEMPLATE_MAP
  (FUNCTION_ID);
  
CREATE INDEX MMP_FUNCTION_TEMPLATE_MAP_TEMPLATE_ID_IX
  ON MMP.FUNCTION_TEMPLATE_MAP
  (TEMPLATE_ID); 
...
INSERT INTO MMP.FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (1, 4000);
INSERT INTO MMP.FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (1, 4001);
INSERT INTO MMP.FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (1, 4002);
INSERT INTO MMP.FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (1, 4003);
INSERT INTO MMP.FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (1, 4004);
...
INSERT INTO MMP.FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (2, 4004);
...
INSERT INTO MMP.EXTERNAL_FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (1, 4000);
INSERT INTO MMP.EXTERNAL_FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (1, 4001);
INSERT INTO MMP.EXTERNAL_FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (1, 4002);
INSERT INTO MMP.EXTERNAL_FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (1, 4003);
INSERT INTO MMP.EXTERNAL_FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (1, 4004);
...
INSERT INTO MMP.EXTERNAL_FUNCTION_GROUP_MAP (GROUP_ID, FUNCTION_ID) VALUES (2, 4004);
