...
--
--    OS X: sudo su postgres -c '/opt/local/lib/postgresql93/bin/pg_ctl -D /opt/local/var/db/postgresql93/defaultdb -l /opt/local/var/db/postgresql93/postgres.log start'
--
--  Execute the following command to create the database:
--
--    OS X: sudo su postgres -c '/opt/local/lib/postgresql93/bin/createdb  --template=template0 --encoding=UNICODE dbname'
--
--  Execute the following command to initialise the database:
--
--    OS X: sudo su postgres -c '/opt/local/lib/postgresql93/bin/psql -d dbname -f ApplicationPostgres.sql'
--
--  Execute the following command to delete the database:
--
--    OS X: sudo su postgres -c '/opt/local/lib/postgresql93/bin/dropdb dbname'
--
--  Execute the following command to clean-up unreferenced large objects on the database:
--
--    OS X: sudo su postgres -c '/opt/local/lib/postgresql93/bin/vacuumlo dbname'
--
-- -------------------------------------------------------------------------------------------------
...
-- CREATE ROLES
-- -------------------------------------------------------------------------------------------------
CREATE ROLE dbuser WITH PASSWORD 'Password1';
...
ALTER TABLE MMP.CODES ADD CONSTRAINT FK_CODES_CODE_CATEGORY FOREIGN KEY (CATEGORY_ID) REFERENCES CODE_CATEGORIES(ID) ON DELETE CASCADE;
...
ALTER TABLE MMP.CACHED_CODE_CATEGORIES ADD CONSTRAINT FK_CACHED_CODE_CATEGORIES_CODE_CATEGORY FOREIGN KEY (ID) REFERENCES CODE_CATEGORIES(ID) ON DELETE CASCADE;
...
ALTER TABLE MMP.CACHED_CODES ADD CONSTRAINT FK_CACHED_CODES_CACHED_CODE_CATEGORY FOREIGN KEY (CATEGORY_ID) REFERENCES CACHED_CODE_CATEGORIES(ID) ON DELETE CASCADE;
...
GRANT ALL ON TABLE MMP.USERS TO dbuser;
GRANT ALL ON TABLE MMP.EXTERNAL_USERS TO dbuser;
GRANT ALL ON TABLE MMP.PASSWORD_HISTORY TO dbuser;
GRANT ALL ON TABLE MMP.GROUPS TO dbuser;
GRANT ALL ON TABLE MMP.EXTERNAL_GROUPS TO dbuser;
GRANT ALL ON TABLE MMP.USER_GROUP_MAP TO dbuser;
GRANT ALL ON TABLE MMP.USER_ORGANISATION_MAP TO dbuser;
GRANT ALL ON TABLE MMP.FUNCTIONS TO dbuser;
GRANT ALL ON TABLE MMP.FUNCTION_TEMPLATES TO dbuser;
GRANT ALL ON TABLE MMP.FUNCTION_USER_MAP TO dbuser;
GRANT ALL ON TABLE MMP.EXTERNAL_FUNCTION_USER_MAP TO dbuser;
GRANT ALL ON TABLE MMP.FUNCTION_GROUP_MAP TO dbuser;
GRANT ALL ON TABLE MMP.EXTERNAL_FUNCTION_GROUP_MAP TO dbuser;
GRANT ALL ON TABLE MMP.FUNCTION_TEMPLATE_MAP TO dbuser;
GRANT ALL ON TABLE MMP.SCHEDULED_TASKS TO dbuser;
GRANT ALL ON TABLE MMP.SCHEDULED_TASK_PARAMETERS TO dbuser;
