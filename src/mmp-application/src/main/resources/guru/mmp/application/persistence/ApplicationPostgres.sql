...
-- CREATE TABLES
-- -------------------------------------------------------------------------------------------------
CREATE TABLE SECURITY.TEST_DATA (
  ID     TEXT NOT NULL,
  NAME   TEXT NOT NULL,
  VALUE  TEXT NOT NULL,
...
COMMENT ON COLUMN SECURITY.TEST_DATA.ID
  IS 'The ID used to uniquely identify the test data';

COMMENT ON COLUMN SECURITY.TEST_DATA.NAME
  IS 'The name for the test data';

COMMENT ON COLUMN SECURITY.TEST_DATA.VALUE
  IS 'The value for the test data';



CREATE TABLE SECURITY.IDGENERATOR (
  NAME     TEXT NOT NULL,
...
COMMENT ON COLUMN SECURITY.IDGENERATOR.NAME
  IS 'The name giving the type of entity associated with the generated ID';

COMMENT ON COLUMN SECURITY.IDGENERATOR.CURRENT
...
COMMENT ON COLUMN SECURITY.CONFIG.KEY
  IS 'The key used to uniquely identify the configuration value';

COMMENT ON COLUMN SECURITY.CONFIG.VALUE
  IS 'The value for the configuration value';

COMMENT ON COLUMN SECURITY.CONFIG.DESCRIPTION
...
CREATE INDEX SECURITY_ORGANISATIONS_NAME_IX
...
CREATE TABLE SECURITY.USER_DIRECTORIES (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT SECURITY_USER_DIRECTORIES_USER_DIRECTORY_TYPE_FK FOREIGN KEY (TYPE_ID) REFERENCES SECURITY.USER_DIRECTORY_TYPES(ID) ON DELETE CASCADE
);

CREATE INDEX SECURITY_USER_DIRECTORIES_NAME_IX
...
CREATE TABLE SECURITY.USER_DIRECTORY_TO_ORGANISATION_MAP (
  ...
  CONSTRAINT SECURITY_USER_DIRECTORY_TO_ORGANISATION_MAP_USER_DIRECTORY_FK FOREIGN KEY (USER_DIRECTORY_ID) REFERENCES SECURITY.USER_DIRECTORIES(ID) ON DELETE CASCADE,
  CONSTRAINT SECURITY_USER_DIRECTORY_TO_ORGANISATION_MAP_ORGANISATION_FK FOREIGN KEY (ORGANISATION_ID) REFERENCES SECURITY.ORGANISATIONS(ID) ON DELETE CASCADE
);

CREATE INDEX SECURITY_USER_DIRECTORY_TO_ORGANISATION_MAP_USER_DIRECTORY_ID_IX
  ON SECURITY.USER_DIRECTORY_TO_ORGANISATION_MAP
  (USER_DIRECTORY_ID);

CREATE INDEX SECURITY_USER_DIRECTORY_TO_ORGANISATION_MAP_ORGANISATION_ID_IX
  ON SECURITY.USER_DIRECTORY_TO_ORGANISATION_MAP
  (ORGANISATION_ID);
...
CREATE TABLE SECURITY.INTERNAL_USERS (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT SECURITY_INTERNAL_USERS_USER_DIRECTORY_FK FOREIGN KEY (USER_DIRECTORY_ID) REFERENCES SECURITY.USER_DIRECTORIES(ID) ON DELETE CASCADE
);

CREATE INDEX SECURITY_INTERNAL_USERS_USER_DIRECTORY_ID_IX
  ON SECURITY.INTERNAL_USERS
  (USER_DIRECTORY_ID);

CREATE UNIQUE INDEX SECURITY_INTERNAL_USERS_USERNAME_IX
  ON SECURITY.INTERNAL_USERS
  (USERNAME);
...
CREATE TABLE SECURITY.INTERNAL_USERS_PASSWORD_HISTORY (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT SECURITY_INTERNAL_USERS_PASSWORD_HISTORY_INTERNAL_USER_ID_FK FOREIGN KEY (INTERNAL_USER_ID) REFERENCES SECURITY.INTERNAL_USERS(ID) ON DELETE CASCADE
);

CREATE INDEX SECURITY_INTERNAL_USERS_PASSWORD_HISTORY_INTERNAL_USER_ID_IX
  ON SECURITY.INTERNAL_USERS_PASSWORD_HISTORY
  (INTERNAL_USER_ID);

CREATE INDEX SECURITY_INTERNAL_USERS_PASSWORD_HISTORY_CHANGED_IX
  ON SECURITY.INTERNAL_USERS_PASSWORD_HISTORY
  (CHANGED);
...
CREATE TABLE SECURITY.INTERNAL_GROUPS (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT SECURITY_INTERNAL_GROUPS_USER_DIRECTORY_FK FOREIGN KEY (USER_DIRECTORY_ID) REFERENCES SECURITY.USER_DIRECTORIES(ID) ON DELETE CASCADE
);

CREATE INDEX SECURITY_INTERNAL_GROUPS_USER_DIRECTORY_ID_IX
  ON SECURITY.INTERNAL_GROUPS
  (USER_DIRECTORY_ID);

CREATE INDEX SECURITY_INTERNAL_GROUPS_GROUPNAME_IX
  ON SECURITY.INTERNAL_GROUPS
  (GROUPNAME);
...
CREATE TABLE SECURITY.INTERNAL_USER_TO_INTERNAL_GROUP_MAP (
  ...
  CONSTRAINT SECURITY_INTERNAL_USER_TO_INTERNAL_GROUP_MAP_INTERNAL_USER_FK FOREIGN KEY (INTERNAL_USER_ID) REFERENCES SECURITY.INTERNAL_USERS(ID) ON DELETE CASCADE,
  CONSTRAINT SECURITY_INTERNAL_USER_TO_INTERNAL_GROUP_MAP_INTERNAL_GROUP_FK FOREIGN KEY (INTERNAL_GROUP_ID) REFERENCES SECURITY.INTERNAL_GROUPS(ID) ON DELETE CASCADE
);

CREATE INDEX SECURITY_INTERNAL_USER_TO_INTERNAL_GROUP_MAP_INTERNAL_USER_ID_IX
  ON SECURITY.INTERNAL_USER_TO_INTERNAL_GROUP_MAP
  (INTERNAL_USER_ID);

CREATE INDEX SECURITY_INTERNAL_USER_TO_INTERNAL_GROUP_MAP_INTERNAL_GROUP_ID_IX
  ON SECURITY.INTERNAL_USER_TO_INTERNAL_GROUP_MAP
  (INTERNAL_GROUP_ID);
...
CREATE INDEX SECURITY_GROUPS_USER_DIRECTORY_ID_IX
  ON SECURITY.GROUPS
  (USER_DIRECTORY_ID);

CREATE INDEX SECURITY_GROUPS_GROUPNAME_IX
  ON SECURITY.GROUPS
  (GROUPNAME);
...
CREATE UNIQUE INDEX SECURITY_FUNCTIONS_CODE_IX
...
CREATE TABLE SECURITY.FUNCTION_TO_ROLE_MAP (
  ...
  CONSTRAINT SECURITY_FUNCTION_TO_ROLE_MAP_FUNCTION_FK FOREIGN KEY (FUNCTION_ID) REFERENCES SECURITY.FUNCTIONS(ID) ON DELETE CASCADE,
  CONSTRAINT SECURITY_FUNCTION_TO_ROLE_MAP_ROLE_FK FOREIGN KEY (ROLE_ID) REFERENCES SECURITY.ROLES(ID) ON DELETE CASCADE
);

CREATE INDEX SECURITY_FUNCTION_TO_ROLE_MAP_FUNCTION_ID_IX
  ON SECURITY.FUNCTION_TO_ROLE_MAP
  (FUNCTION_ID);

CREATE INDEX SECURITY_FUNCTION_TO_ROLE_MAP_ROLE_ID_IX
  ON SECURITY.FUNCTION_TO_ROLE_MAP
  (ROLE_ID);
...
CREATE TABLE SECURITY.ROLE_TO_GROUP_MAP (
  ...
  CONSTRAINT SECURITY_ROLE_TO_GROUP_MAP_ROLE_FK FOREIGN KEY (ROLE_ID) REFERENCES SECURITY.ROLES(ID) ON DELETE CASCADE,
  CONSTRAINT SECURITY_ROLE_TO_GROUP_MAP_GROUP_FK FOREIGN KEY (GROUP_ID) REFERENCES SECURITY.GROUPS(ID) ON DELETE CASCADE
);

CREATE INDEX SECURITY_ROLE_TO_GROUP_MAP_ROLE_ID_IX
  ON SECURITY.ROLE_TO_GROUP_MAP
  (ROLE_ID);

CREATE INDEX SECURITY_ROLE_TO_GROUP_MAP_GROUP_ID_IX
  ON SECURITY.ROLE_TO_GROUP_MAP
  (GROUP_ID);
...
CREATE TABLE SCHEDULER.JOB_PARAMETERS (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT SCHEDULER_JOB_PARAMETERS_JOB_FK FOREIGN KEY (JOB_ID) REFERENCES SCHEDULER.JOBS(ID) ON DELETE CASCADE
);

CREATE INDEX SCHEDULER_JOB_PARAMETERS_JOB_ID_IX
  ON SCHEDULER.JOB_PARAMETERS
  (JOB_ID);

CREATE INDEX SCHEDULER_JOB_PARAMETERS_NAME_IX
  ON SCHEDULER.JOB_PARAMETERS
  (NAME);
...
CREATE TABLE CODES.CODES (
  ...
  CONSTRAINT CODES_CODES_CODE_CATEGORY_FK FOREIGN KEY (CATEGORY_ID) REFERENCES CODES.CODE_CATEGORIES(ID) ON DELETE CASCADE
);

CREATE INDEX CODES_CODES_CATEGORY_ID_IX
  ON CODES.CODES
  (CATEGORY_ID);
...
CREATE TABLE CODES.CACHED_CODE_CATEGORIES (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT CODES_CACHED_CODE_CATEGORIES_CODE_CATEGORY_FK FOREIGN KEY (ID) REFERENCES CODES.CODE_CATEGORIES(ID) ON DELETE CASCADE
);
...
CREATE TABLE CODES.CACHED_CODES (
  ...
  CONSTRAINT CODES_CACHED_CODES_CACHED_CODE_CATEGORY_FK FOREIGN KEY (CATEGORY_ID) REFERENCES CODES.CACHED_CODE_CATEGORIES(ID) ON DELETE CASCADE
);

CREATE INDEX CODES_CACHED_CODES_CATEGORY_ID_IX
...
CREATE TABLE MESSAGING.MESSAGES (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT MESSAGING_MESSAGES_MESSAGE_TYPE_FK FOREIGN KEY (TYPE_ID) REFERENCES MESSAGING.MESSAGE_TYPES(ID),
  CONSTRAINT MESSAGING_MESSAGES_MESSAGE_STATUS_FK FOREIGN KEY (STATUS) REFERENCES MESSAGING.MESSAGE_STATUSES(CODE)
);

CREATE INDEX MESSAGING_MESSAGES_USERNAME_IX
  ON MESSAGING.MESSAGES
  (USERNAME);

CREATE INDEX MESSAGING_MESSAGES_DEVICE_ID_IX
  ON MESSAGING.MESSAGES
  (DEVICE_ID);

CREATE INDEX MESSAGING_MESSAGES_TYPE_ID_IX
  ON MESSAGING.MESSAGES
  (TYPE_ID);

CREATE INDEX MESSAGING_MESSAGES_PRIORITY_IX
  ON MESSAGING.MESSAGES
  (PRIORITY);

CREATE INDEX MESSAGING_MESSAGES_STATUS_IX
  ON MESSAGING.MESSAGES
  (STATUS);

CREATE INDEX MESSAGING_MESSAGES_LOCK_NAME_IX
  ON MESSAGING.MESSAGES
  (LOCK_NAME);
...
CREATE TABLE MESSAGING.MESSAGE_PARTS (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT MESSAGING_MESSAGE_PARTS_MESSAGE_TYPE_FK FOREIGN KEY (MSG_TYPE_ID) REFERENCES MESSAGING.MESSAGE_TYPES(ID)
);

CREATE INDEX MESSAGING_MESSAGE_PARTS_STATUS_IX
  ON MESSAGING.MESSAGE_PARTS
  (STATUS);

CREATE INDEX MESSAGING_MESSAGE_PARTS_MSG_ID_IX
  ON MESSAGING.MESSAGE_PARTS
  (MSG_ID);

CREATE INDEX MESSAGING_MESSAGE_PARTS_MSG_DEVICE_ID_IX
  ON MESSAGING.MESSAGE_PARTS
  (MSG_DEVICE_ID);

CREATE INDEX MESSAGING_MESSAGE_PARTS_MSG_TYPE_ID_IX
  ON MESSAGING.MESSAGE_PARTS
  (MSG_TYPE_ID);

CREATE INDEX MESSAGING_MESSAGE_PARTS_LOCK_NAME_IX
  ON MESSAGING.MESSAGE_PARTS
  (LOCK_NAME);
...
CREATE TABLE MESSAGING.ARCHIVED_MESSAGES (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT MESSAGING_ARCHIVED_MESSAGES_MESSAGE_TYPE_FK FOREIGN KEY (TYPE_ID) REFERENCES MESSAGING.MESSAGE_TYPES(ID)
);

CREATE INDEX MESSAGING_ARCHIVED_MESSAGES_USERNAME_IX
  ON MESSAGING.ARCHIVED_MESSAGES
  (USERNAME);

CREATE INDEX MESSAGING_ARCHIVED_MESSAGES_DEVICE_ID_IX
  ON MESSAGING.ARCHIVED_MESSAGES
  (DEVICE_ID);

CREATE INDEX MESSAGING_ARCHIVED_MESSAGES_TYPE_ID_IX
  ON MESSAGING.ARCHIVED_MESSAGES
  (TYPE_ID);
...
CREATE INDEX MESSAGING_ERROR_REPORTS_APPLICATION_ID_IX
  ON MESSAGING.ERROR_REPORTS
  (APPLICATION_ID);

CREATE INDEX MESSAGING_ERROR_REPORTS_CREATED_IX
  ON MESSAGING.ERROR_REPORTS
  (CREATED);

CREATE INDEX MESSAGING_ERROR_REPORTS_WHO_IX
  ON MESSAGING.ERROR_REPORTS
  (WHO);
...
CREATE INDEX SMS_SMS_MOBILE_NUMBER_IX
  ON SMS.SMS
  (MOBILE_NUMBER);
...
INSERT INTO SECURITY.TEST_DATA (ID, NAME, VALUE) VALUES (1, 'Sample Name 1', 'Sample Value 1');
INSERT INTO SECURITY.TEST_DATA (ID, NAME, VALUE) VALUES (2, 'Sample Name 2', 'Sample Value 2');
INSERT INTO SECURITY.TEST_DATA (ID, NAME, VALUE) VALUES (3, 'Sample Name 3', 'Sample Value 3');
INSERT INTO SECURITY.TEST_DATA (ID, NAME, VALUE) VALUES (4, 'Sample Name 4', 'Sample Value 4');
INSERT INTO SECURITY.TEST_DATA (ID, NAME, VALUE) VALUES (5, 'Sample Name 5', 'Sample Value 5');
INSERT INTO SECURITY.TEST_DATA (ID, NAME, VALUE) VALUES (6, 'Sample Name 6', 'Sample Value 6');
INSERT INTO SECURITY.TEST_DATA (ID, NAME, VALUE) VALUES (7, 'Sample Name 7', 'Sample Value 7');
INSERT INTO SECURITY.TEST_DATA (ID, NAME, VALUE) VALUES (8, 'Sample Name 8', 'Sample Value 8');
INSERT INTO SECURITY.TEST_DATA (ID, NAME, VALUE) VALUES (9, 'Sample Name 9', 'Sample Value 9');
...
GRANT ALL ON TABLE SECURITY.TEST_DATA TO dbuser;
GRANT ALL ON TABLE SECURITY.IDGENERATOR TO dbuser;
GRANT ALL ON TABLE SECURITY.CONFIG TO dbuser;
GRANT ALL ON TABLE SECURITY.REGISTRY TO dbuser;
...
GRANT ALL ON TABLE SECURITY.PACKAGES TO dbuser;
...
GRANT ALL ON TABLE SECURITY.PROCESS_DEFINITIONS TO dbuser;
GRANT ALL ON TABLE SECURITY.PROCESS_INSTANCES TO dbuser;
GRANT ALL ON TABLE SECURITY.PROCESS_INSTANCE_EVENTS TO dbuser;
GRANT ALL ON TABLE SECURITY.CUSTOMERS TO dbuser;
GRANT ALL ON TABLE SECURITY.CUSTOMER_ADDRESSES TO dbuser;
