...
--
--      _                _ _           _   _             ____           _                                      _ 
--     / \   _ __  _ __ | (_) ___ __ _| |_(_) ___  _ __ |  _ \ ___  ___| |_ __ _ _ __ ___  ___ ___   ___  __ _| |
--    / _ \ | '_ \| '_ \| | |/ __/ _` | __| |/ _ \| '_ \| |_) / _ \/ __| __/ _` | '__/ _ \/ __/ __| / __|/ _` | |
--   / ___ \| |_) | |_) | | | (_| (_| | |_| | (_) | | | |  __/ (_) \__ \ || (_| | | |  __/\__ \__ \_\__ \ (_| | |
--  /_/   \_\ .__/| .__/|_|_|\___\__,_|\__|_|\___/|_| |_|_|   \___/|___/\__\__, |_|  \___||___/___(_)___/\__, |_|
--          |_|   |_|                                                      |___/                            |_|  
--
-- ------------------------------------------------------------------------------------------------------------------
...
CREATE USER dbuser WITH PASSWORD 'Password1';
...
INSERT INTO IDGENERATOR (NAME, CURRENT) VALUES
  ('Application.OrganisationId', 10000);
INSERT INTO IDGENERATOR (NAME, CURRENT) VALUES
  ('Application.UserId', 10000);
INSERT INTO IDGENERATOR (NAME, CURRENT) VALUES
  ('Application.UserPasswordHistoryId', 10000);
INSERT INTO IDGENERATOR (NAME, CURRENT) VALUES
  ('Application.GroupId', 10000);
INSERT INTO IDGENERATOR (NAME, CURRENT) VALUES
  ('Application.FunctionId', 10000);
INSERT INTO IDGENERATOR (NAME, CURRENT) VALUES
  ('Application.FunctionTemplateId', 10000);
INSERT INTO IDGENERATOR (NAME, CURRENT) VALUES
  ('Application.ScheduledTaskParameterId', 10000);
INSERT INTO IDGENERATOR (NAME, CURRENT) VALUES
  ('Application.CodeId', 1000000);
...
-- SET PERMISSIONS
-- -------------------------------------------------------------------------------------------------
GRANT ALL ON TABLE CODE_CATEGORIES TO dbuser;
GRANT ALL ON TABLE CODES TO dbuser;
GRANT ALL ON TABLE CACHED_CODE_CATEGORIES TO dbuser;
GRANT ALL ON TABLE CACHED_CODES TO dbuser;

GRANT ALL ON TABLE SCHEDULED_TASK_PARAMETERS TO dbuser;
GRANT ALL ON TABLE SCHEDULED_TASKS TO dbuser;

GRANT ALL ON TABLE USER_ORGANISATION_MAP TO dbuser;
GRANT ALL ON TABLE USER_GROUP_MAP TO dbuser;
GRANT ALL ON TABLE FUNCTION_USER_MAP TO dbuser;
GRANT ALL ON TABLE EXTERNAL_FUNCTION_USER_MAP TO dbuser;
GRANT ALL ON TABLE FUNCTION_GROUP_MAP TO dbuser;
GRANT ALL ON TABLE EXTERNAL_FUNCTION_GROUP_MAP TO dbuser;
GRANT ALL ON TABLE FUNCTION_TEMPLATE_MAP TO dbuser;
GRANT ALL ON TABLE FUNCTIONS TO dbuser;
GRANT ALL ON TABLE FUNCTION_TEMPLATES TO dbuser;
GRANT ALL ON TABLE PASSWORD_HISTORY TO dbuser;
GRANT ALL ON TABLE USERS TO dbuser;
GRANT ALL ON TABLE EXTERNAL_USERS TO dbuser;
GRANT ALL ON TABLE GROUPS TO dbuser;
GRANT ALL ON TABLE EXTERNAL_GROUPS TO dbuser;
GRANT ALL ON TABLE ORGANISATIONS TO dbuser;
GRANT ALL ON TABLE IDGENERATOR TO dbuser;  

GRANT ALL ON TABLE SERVICE_REGISTRY TO dbuser;
GRANT ALL ON TABLE REGISTRY TO dbuser;
