 ...
 */
public class JQueryMultiSelectCssResourceReference
  extends CssResourceReference
{
  ...
  private static final JQueryMultiSelectCssResourceReference INSTANCE = new
  ...
  {
    super(JQueryMultiSelectCssResourceReference.class,
      Debug.inDebugMode() ? "css/multi-select.css" : "css/multi-select.css");
  }
}
