...
/**
 * The <code>TemplateFormsCssResourceReference</code> class implements the CSS resource
 * reference for the template-forms.css CSS file that forms part of the
 * Web Application Template.
 *
 * @author Marcus Portmann
 */
public class TemplateFormsCssResourceReference
  extends CssResourceReference
{
  private static final long serialVersionUID = 1000000;
  private static final TemplateFormsCssResourceReference INSTANCE =
    new TemplateFormsCssResourceReference();
  private static final CssHeaderItem CSS_HEADER_ITEM =
    CssHeaderItem.forReference(new TemplateFormsCssResourceReference());

  private TemplateFormsCssResourceReference()
  {
    super(TemplateFormsCssResourceReference.class, Debug.inDebugMode()
      ? "css/template-forms.css"
      : "css/template-forms.css");
  }
   ...
   *         CSS file that forms part of the Web Application Template
   */
  public static TemplateFormsCssResourceReference get()
  {
    return INSTANCE;
  }
