 ...
 * reference for the Bootstrap library bundled with the web application library.
 *
...
public class BootstrapJavaScriptResourceReference extends JavaScriptResourceReference
{
  ...
  private static final JavaScriptHeaderItem JAVA_SCRIPT_HEADER_ITEM =
    JavaScriptHeaderItem.forReference(new BootstrapJavaScriptResourceReference());
  private static final BootstrapJavaScriptResourceReference INSTANCE =
    new BootstrapJavaScriptResourceReference();

  private BootstrapJavaScriptResourceReference()
  {
    super(BootstrapJavaScriptResourceReference.class, Debug.inDebugMode()
        ? "js/bootstrap.js"
        : "js/bootstrap.min.js");
  }

  /**
   * Returns the single instance of the JavaScript resource reference for the Bootstrap library
   * bundled with the web application library.
   *
   * @return the single instance of the JavaScript resource reference for the Bootstrap library
   *         bundled with the web application library
   */
  ...
  /**
   * Returns the JavaScript header item for the Bootstrap library bundled with the web application
   * library.
   *
   * @return the JavaScript header item for the Bootstrap library bundled with the web application
   *         library
   */
