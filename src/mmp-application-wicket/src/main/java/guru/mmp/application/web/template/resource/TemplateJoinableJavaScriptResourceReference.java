...
/**
 * The <code>TemplateJoinableJavaScriptResourceReference</code> class implements the
 * JavaScript resource reference for the template-joinable.js resource that forms part of the
 * Web Application Template.
 *
 * @author Marcus Portmann
 */
public class TemplateJoinableJavaScriptResourceReference extends JavaScriptResourceReference
{
  private static final long serialVersionUID = 1000000;
  private static final JavaScriptHeaderItem JAVA_SCRIPT_HEADER_ITEM =
    JavaScriptHeaderItem.forReference(new TemplateJoinableJavaScriptResourceReference());
  private static final TemplateJoinableJavaScriptResourceReference INSTANCE =
    new TemplateJoinableJavaScriptResourceReference();
   ...
   * template-joinable.js resource that forms part of the Web Application Template.
   *
   * @return the single instance of the JavaScript resource reference for the
   *         template-joinable.js resource that forms part of the Web Application Template
   */
  public static TemplateJoinableJavaScriptResourceReference get()
  {
    return INSTANCE;
  }
