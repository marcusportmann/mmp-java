...
/**
 * The <code>TemplateCustomJavaScriptResourceReference</code> class implements the
 * JavaScript resource reference for the template-custom.js resource that forms part of the
 * Web Application Template.
 *
 * @author Marcus Portmann
 */
public class TemplateCustomJavaScriptResourceReference extends JavaScriptResourceReference
{
  private static final long serialVersionUID = 1000000;
  private static final JavaScriptHeaderItem JAVA_SCRIPT_HEADER_ITEM =
    JavaScriptHeaderItem.forReference(new TemplateCustomJavaScriptResourceReference());
  private static final TemplateCustomJavaScriptResourceReference INSTANCE =
    new TemplateCustomJavaScriptResourceReference();
   ...
   *         template-custom.js resource that forms part of the Web Application Template
   */
  public static TemplateCustomJavaScriptResourceReference get()
  {
    return INSTANCE;
  }
