...
public class OrganisationDataProvider extends InjectableDataProvider<Organisation>
{
   ...
   *
   * @return the organisations from the database starting with index <code>first</code> and
  ...
  /**
   * Returns the total number of matching organisations in the database.
   *
   * @see org.apache.wicket.markup.repeater.data.IDataProvider#size()
   *
   * @return the total number of matching organisations in the database
   */
  public long size()
  {
    try
