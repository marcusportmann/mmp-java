...
/**
 * The <code>WebApplicationException</code> exception is thrown to indicate an error condition when
 * working with a Wicket <code>WebApplication</code>.
 *
...
public class WebApplicationException extends RuntimeException
{
  ...
  /**
   * Constructs a new <code>WebApplicationException</code> with <code>null</code> as its message.
   */
  ...
  /**
   * Constructs a new <code>WebApplicationException</code> with the specified message.
   *
  ...
  /**
   * Constructs a new <code>WebApplicationException</code> with the specified cause and a message
  ...
  /**
   * Constructs a new <code>WebApplicationException</code> with the specified code and message.
   *
   * @param code    the error code identifying the error
   * @param message The message saved for later retrieval by the <code>getMessage()</code> method.
   */
  public WebApplicationException(String code, String message)
  {
    super(message);
    this.code = code;
    this.when = new Date();
  ...
  /**
   * Constructs a new <code>WebApplicationException</code> with the specified message and cause.
   *
   * @param message The message saved for later retrieval by the <code>getMessage()</code> method.
   * @param cause   The cause saved for later retrieval by the <code>getCause()</code> method.
   *                (A <code>null</code> value is permitted if the cause is nonexistent or unknown)
  ...
  /**
   * Constructs a new <code>WebApplicationException</code> with the specified code, message and
   * cause.
   *
   * @param code    the error code identifying the error
   * @param message The message saved for later retrieval by the <code>getMessage()</code> method.
   ...
   *                (A <code>null</code> value is permitted if the cause is nonexistent or unknown)
   */
  public WebApplicationException(String code, String message, Throwable cause)
  {
    super(message, cause);
    this.code = code;
    this.when = new Date();
