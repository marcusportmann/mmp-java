...
/**
 * The <code>TemplateWidgetsJavaScriptResourceReference</code> class implements the
 * JavaScript resource reference for the template-widgets.js resource that forms part of the
 * Web Application Template.
 *
 * @author Marcus Portmann
 */
public class TemplateWidgetsJavaScriptResourceReference extends JavaScriptResourceReference
{
  private static final long serialVersionUID = 1000000;
  private static final JavaScriptHeaderItem JAVA_SCRIPT_HEADER_ITEM =
    JavaScriptHeaderItem.forReference(new TemplateWidgetsJavaScriptResourceReference());
  private static final TemplateWidgetsJavaScriptResourceReference INSTANCE =
    new TemplateWidgetsJavaScriptResourceReference();
   ...
   * template-widgets.js resource that forms part of the Web Application Template.
   *
   * @return the single instance of the JavaScript resource reference for the
   *         template-widgets.js resource that forms part of the Web Application Template
   */
  public static TemplateWidgetsJavaScriptResourceReference get()
  {
    return INSTANCE;
  }
