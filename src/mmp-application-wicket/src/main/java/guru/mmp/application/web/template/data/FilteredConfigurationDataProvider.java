...
/**
 * The <code>FilteredConfigurationDataProvider</code> class provides an <code>IDataProvider</code>
 * implementation that retrieves a filtered list of <code>Entry</code> instances from the
 * Configuration Service that represent configuration values.
 *
 * @author Marcus Portmann
 */
public class FilteredConfigurationDataProvider extends InjectableDataProvider< Map.Entry<String, String> >
{
  ...
  protected FilteredConfigurationDataProvider() {}
   ...
   *                        user directory
   */
  public FilteredConfigurationDataProvider(UUID userDirectoryId)
  {
