 ...
 */
public class RWDTableJavaScriptResourceReference
  extends JavaScriptResourceReference
{
  private static final RWDTableJavaScriptResourceReference INSTANCE = new
    RWDTableJavaScriptResourceReference();
  ...
  {
    super(RWDTableJavaScriptResourceReference.class,
      Debug.inDebugMode() ? "js/rwd-table.js" : "js/rwd-table.min.js");
  }
