...
/**
 * The <code>Select2BootstrapCssResourceReference</code> class implements the CSS resource
 * reference for the Select2 Bootstrap thirdparty resource bundled with the Web Application
 * Template.
 *
