 ...
 * reference for the jQuery UI library bundled with the web application library.
 *
...
public class JQueryUIJavaScriptResourceReference extends JavaScriptResourceReference
{
  ...
  /**
   * Returns the single instance of the JavaScript resource reference for the jQuery UI library
   * bundled with the web application library.
   *
   * @return the single instance of the JavaScript resource reference for the jQuery UI library
   *         bundled with the web application library
   */
  ...
  /**
   * Returns the JavaScript header item for the jQuery UI library bundled with the web application
   * library.
   *
   * @return the JavaScript header item for the jQuery UI library bundled with the web application
   *         library
   */
