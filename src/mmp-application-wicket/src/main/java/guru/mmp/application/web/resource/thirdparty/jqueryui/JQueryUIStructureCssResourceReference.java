...
public class JQueryUIStructureCssResourceReference
  extends CssResourceReference
{
  ...
  private static final JQueryUIStructureCssResourceReference INSTANCE = new
    JQueryUIStructureCssResourceReference();
  ...
  {
    super(JQueryUIStructureCssResourceReference.class,
      Debug.inDebugMode() ? "jquery-ui.structure.css" : "jquery-ui.structure.min.css");
  }
}
