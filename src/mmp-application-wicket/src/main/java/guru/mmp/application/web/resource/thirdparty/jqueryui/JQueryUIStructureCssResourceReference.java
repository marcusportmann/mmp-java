...
/**
 * The <code>JQueryUIStructureCssResourceReference</code> class implements the CSS resource
 * reference for the JQuery UI thirdparty resource bundled with the Web Application Template.
 *
 * @author Marcus Portmann
 */
public class JQueryUIStructureCssResourceReference extends CssResourceReference
{
  private static final long serialVersionUID = 1000000;
  private static final JQueryUIStructureCssResourceReference INSTANCE =
    new JQueryUIStructureCssResourceReference();
  private static final CssHeaderItem CSS_HEADER_ITEM =
    CssHeaderItem.forReference(new JQueryUIStructureCssResourceReference());

  private JQueryUIStructureCssResourceReference()
  {
    super(JQueryUIStructureCssResourceReference.class, Debug.inDebugMode()
   ...
   *         with the Web Application Template
   */
  public static JQueryUIStructureCssResourceReference get()
  {
    return INSTANCE;
  }
