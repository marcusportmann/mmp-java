...
(function ($) {
    ...
    ResponsiveTable.prototype.createButtonToolbar = function() {
        ...
        this.$dropdownGroup = $('<div class="btn-group dropdown-btn-group pull-right" dropdown/>');
        this.$dropdownBtn = $('<button class="btn btn-default dropdown-toggle" dropdown-toggle>Display <span class="caret"></span></button>');
        this.$dropdownContainer = $('<ul class="dropdown-menu" dropdown-menu/>');
