...
(function ($, window, undefined)
{
  ...
  $(document).ready(function ()
  {
    ...
    {
      stickFooterToBottom();
      $(window).on('template.resized', stickFooterToBottom);
    }
    ...
    //cbr_replace(); -- Removed this and replaced with the below to support the column selection on the responsive table -- MARCUS
...
function show_form_control_feedback(field_name, feedback_class, feedback_message)
{
  ...
  {
    if ($(feedback_field_name).parent().hasClass('form-group'))
    {
      $(feedback_field_name).parent().addClass(feedback_class);
    }

    if ($(feedback_field_name).parent().parent().hasClass('form-group'))
    {
...
function clear_form_control_feedback(field_name)
{
  ...
  if ($(feedback_field_name))
  {
    if ($(feedback_field_name).parent().hasClass('form-group'))
    {
      $(feedback_field_name).parent().removeClass('has-error has-warning has-info has-success');
    }
