 ...
 */
@WebServiceClient(name = "Lists", targetNamespace = "http://schemas.microsoft" +
  ".com/sharepoint/soap/", wsdlLocation =
  "file:/C:/Data/Develop/MMP/mmp-java/src/mmp-sharepoint/src/main/resources/META-INF/wsdl" +
    "/SharePointListsService.wsdl")
public class Lists
  extends Service
{
  ...
  private final static QName LISTS_QNAME = new QName(
    "http://schemas.microsoft.com/sharepoint/soap/", "Lists");
