...
/**
 * The <code>ModalsPage</code> class implements the "Modals"
 * page for the web application.
 *
 * @author Marcus Portmann
 */
public class ModalsPage extends TemplateWebPage
{
  private static final long serialVersionUID = 1000000;

  /**
   * Constructs a new <code>ModalsPage</code>.
   */
  public ModalsPage()
  {
    super("Modals", "Modals and their variants");
  }
