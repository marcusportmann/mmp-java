...
/**
 * The <code>PanelsPage</code> class implements the "Panels"
 * page for the web application.
 *
 * @author Marcus Portmann
 */
public class PanelsPage extends TemplateWebPage
{
  private static final long serialVersionUID = 1000000;

  /**
   * Constructs a new <code>PanelsPage</code>.
   */
  public PanelsPage()
  {
    super("Panels", "Panels and their variants");
  }
