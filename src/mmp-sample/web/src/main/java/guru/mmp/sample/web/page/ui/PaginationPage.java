...
/**
 * The <code>PaginationPage</code> class implements the "Pagination"
 * page for the web application.
 *
 * @author Marcus Portmann
 */
public class PaginationPage extends TemplateWebPage
{
  ...
  {
    super("Pagination", "Pagination, pagers and their variants");
  }
