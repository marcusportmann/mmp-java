...
/**
 * The <code>ProgressBarsPage</code> class implements the "Progress Bars"
 * page for the web application.
 *
 * @author Marcus Portmann
 */
public class ProgressBarsPage extends TemplateWebPage
{
  private static final long serialVersionUID = 1000000;

  /**
   * Constructs a new <code>ProgressBarsPage</code>.
   */
  public ProgressBarsPage()
  {
    super("Progress Bars", "Progress bars and their variants");
  }
