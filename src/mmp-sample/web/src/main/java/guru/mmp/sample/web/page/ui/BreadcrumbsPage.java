...
/**
 * The <code>BreadcrumbsPage</code> class implements the "Breadcrumbs"
 * page for the web application.
 *
 * @author Marcus Portmann
 */
public class BreadcrumbsPage extends TemplateWebPage
{
  private static final long serialVersionUID = 1000000;

  /**
   * Constructs a new <code>BreadcrumbsPage</code>.
   */
  public BreadcrumbsPage()
  {
    super("Breadcrumbs", "Breadcrumbs and their variants");
  }
