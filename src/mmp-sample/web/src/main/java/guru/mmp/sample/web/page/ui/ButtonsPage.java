...
/**
 * The <code>ButtonsPage</code> class implements the "Buttons"
 * page for the web application.
 *
 * @author Marcus Portmann
 */
public class ButtonsPage extends TemplateWebPage
{
  private static final long serialVersionUID = 1000000;

  /**
   * Constructs a new <code>ButtonsPage</code>.
   */
  public ButtonsPage()
  {
    super("Buttons", "Buttons with dropdowns and their variants");
  }
