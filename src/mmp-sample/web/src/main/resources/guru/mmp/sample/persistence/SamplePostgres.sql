...
--
--    OS X: sudo su postgres -c '/opt/local/lib/postgresql93/bin/psql -d sampledb -f SamplePostgres.sql'
--
...
GRANT ALL ON SCHEMA SAMPLE TO sampledb;
...
GRANT ALL ON TABLE SAMPLE.DATA TO sampledb;
