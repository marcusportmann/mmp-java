...
--       - SamplePostgres.sql (mmp-application)
--
...
--
--    OS X: sudo su postgres -c '/opt/local/lib/postgresql94/bin/createdb  --template=template1 --encoding=UTF8 sample'
...
--
--    OS X: sudo su postgres -c '/opt/local/lib/postgresql94/bin/psql -d sample -f SamplePostgres.sql'
--    CentOS (as root): su postgres -c 'psql -d sample -f SamplePostgres.sql'
--
--  Execute the following command to delete the database:
--
--    OS X: sudo su postgres -c '/opt/local/lib/postgresql94/bin/dropdb sample'
...
--
--    OS X: sudo su postgres -c '/opt/local/lib/postgresql94/bin/vacuumlo sample'
