    ...
    implements Serializable
{
    ...
    protected Calendar sourceLastChanged;
    ...
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "dateTime")
    protected Calendar lastStatusUpdate;
    @XmlElement(required = true)
     ...
     *     
     */
    public void setSourceLastChanged(Calendar value) {
     ...
     *     
     */
    public void setLastStatusUpdate(Calendar value) {
