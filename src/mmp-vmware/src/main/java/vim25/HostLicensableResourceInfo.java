...
/**
 * <p>Java class for HostLicensableResourceInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="resource" type="{urn:vim25}KeyAnyValue" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    public List<KeyAnyValue> getResource() {
        if (resource == null) {
            resource = new ArrayList<KeyAnyValue>();
        }
