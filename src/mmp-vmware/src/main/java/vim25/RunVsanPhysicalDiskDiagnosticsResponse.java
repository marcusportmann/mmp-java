 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}HostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    public List<HostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<HostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult>();
        }
