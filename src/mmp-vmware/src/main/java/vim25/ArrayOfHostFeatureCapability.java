...
/**
 * <p>Java class for ArrayOfHostFeatureCapability complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostFeatureCapability" type="{urn:vim25}HostFeatureCapability" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostFeatureCapability property.
     * 
     * <p>
    ...
    public List<HostFeatureCapability> getHostFeatureCapability() {
        if (hostFeatureCapability == null) {
            hostFeatureCapability = new ArrayList<HostFeatureCapability>();
        }
