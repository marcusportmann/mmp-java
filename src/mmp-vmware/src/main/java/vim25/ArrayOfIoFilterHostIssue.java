...
/**
 * <p>Java class for ArrayOfIoFilterHostIssue complex type.
 * 
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the ioFilterHostIssue property.
     * 
     * <p>
    ...
    public List<IoFilterHostIssue> getIoFilterHostIssue() {
        if (ioFilterHostIssue == null) {
            ioFilterHostIssue = new ArrayList<IoFilterHostIssue>();
        }
