...
/**
 * <p>Java class for ArrayOfGuestFileInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="GuestFileInfo" type="{urn:vim25}GuestFileInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the guestFileInfo property.
     * 
     * <p>
    ...
    public List<GuestFileInfo> getGuestFileInfo() {
        if (guestFileInfo == null) {
            guestFileInfo = new ArrayList<GuestFileInfo>();
        }
