...
/**
 * <p>Java class for ArrayOfHostLowLevelProvisioningManagerFileDeleteSpec complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostLowLevelProvisioningManagerFileDeleteSpec" type="{urn:vim25}HostLowLevelProvisioningManagerFileDeleteSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostLowLevelProvisioningManagerFileDeleteSpec property.
     * 
     * <p>
    ...
    public List<HostLowLevelProvisioningManagerFileDeleteSpec> getHostLowLevelProvisioningManagerFileDeleteSpec() {
        if (hostLowLevelProvisioningManagerFileDeleteSpec == null) {
            hostLowLevelProvisioningManagerFileDeleteSpec = new ArrayList<HostLowLevelProvisioningManagerFileDeleteSpec>();
        }
