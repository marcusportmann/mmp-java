...
/**
 * <p>Java class for ArrayOfHostLowLevelProvisioningManagerSnapshotLayoutSpec complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostLowLevelProvisioningManagerSnapshotLayoutSpec" type="{urn:vim25}HostLowLevelProvisioningManagerSnapshotLayoutSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostLowLevelProvisioningManagerSnapshotLayoutSpec property.
     * 
     * <p>
    ...
    public List<HostLowLevelProvisioningManagerSnapshotLayoutSpec> getHostLowLevelProvisioningManagerSnapshotLayoutSpec() {
        if (hostLowLevelProvisioningManagerSnapshotLayoutSpec == null) {
            hostLowLevelProvisioningManagerSnapshotLayoutSpec = new ArrayList<HostLowLevelProvisioningManagerSnapshotLayoutSpec>();
        }
