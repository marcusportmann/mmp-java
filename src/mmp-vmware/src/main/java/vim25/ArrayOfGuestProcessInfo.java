...
/**
 * <p>Java class for ArrayOfGuestProcessInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="GuestProcessInfo" type="{urn:vim25}GuestProcessInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the guestProcessInfo property.
     * 
     * <p>
    ...
    public List<GuestProcessInfo> getGuestProcessInfo() {
        if (guestProcessInfo == null) {
            guestProcessInfo = new ArrayList<GuestProcessInfo>();
        }
