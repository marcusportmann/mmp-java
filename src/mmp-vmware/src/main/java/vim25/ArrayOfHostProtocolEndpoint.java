...
/**
 * <p>Java class for ArrayOfHostProtocolEndpoint complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostProtocolEndpoint" type="{urn:vim25}HostProtocolEndpoint" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostProtocolEndpoint property.
     * 
     * <p>
    ...
    public List<HostProtocolEndpoint> getHostProtocolEndpoint() {
        if (hostProtocolEndpoint == null) {
            hostProtocolEndpoint = new ArrayList<HostProtocolEndpoint>();
        }
