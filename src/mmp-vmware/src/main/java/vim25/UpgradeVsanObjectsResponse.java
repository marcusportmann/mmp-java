 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}HostVsanInternalSystemVsanObjectOperationResult" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    public List<HostVsanInternalSystemVsanObjectOperationResult> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<HostVsanInternalSystemVsanObjectOperationResult>();
        }
