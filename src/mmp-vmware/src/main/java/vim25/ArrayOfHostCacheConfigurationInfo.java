...
/**
 * <p>Java class for ArrayOfHostCacheConfigurationInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="HostCacheConfigurationInfo" type="{urn:vim25}HostCacheConfigurationInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostCacheConfigurationInfo property.
     * 
     * <p>
    ...
    public List<HostCacheConfigurationInfo> getHostCacheConfigurationInfo() {
        if (hostCacheConfigurationInfo == null) {
            hostCacheConfigurationInfo = new ArrayList<HostCacheConfigurationInfo>();
        }
