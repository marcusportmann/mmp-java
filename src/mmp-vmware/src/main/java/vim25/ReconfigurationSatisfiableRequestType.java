...
/**
 * <p>Java class for ReconfigurationSatisfiableRequestType complex type.
 * 
 ...
 *         &lt;element name="pcbs" type="{urn:vim25}VsanPolicyChangeBatch" maxOccurs="unbounded"/>
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the pcbs property.
     * 
     * <p>
    ...
    public List<VsanPolicyChangeBatch> getPcbs() {
        if (pcbs == null) {
            pcbs = new ArrayList<VsanPolicyChangeBatch>();
        }
        return this.pcbs;
    }
