...
/**
 * <p>Java class for ArrayOfOvfOptionInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="OvfOptionInfo" type="{urn:vim25}OvfOptionInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the ovfOptionInfo property.
     * 
     * <p>
    ...
    public List<OvfOptionInfo> getOvfOptionInfo() {
        if (ovfOptionInfo == null) {
            ovfOptionInfo = new ArrayList<OvfOptionInfo>();
        }
