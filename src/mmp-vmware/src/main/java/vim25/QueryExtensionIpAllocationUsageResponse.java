 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}ExtensionManagerIpAllocationUsage" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    public List<ExtensionManagerIpAllocationUsage> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<ExtensionManagerIpAllocationUsage>();
        }
