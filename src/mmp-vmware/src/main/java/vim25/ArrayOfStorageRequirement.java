...
/**
 * <p>Java class for ArrayOfStorageRequirement complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="StorageRequirement" type="{urn:vim25}StorageRequirement" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the storageRequirement property.
     * 
     * <p>
    ...
    public List<StorageRequirement> getStorageRequirement() {
        if (storageRequirement == null) {
            storageRequirement = new ArrayList<StorageRequirement>();
        }
