...
/**
 * <p>Java class for ArrayOfServiceManagerServiceInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="ServiceManagerServiceInfo" type="{urn:vim25}ServiceManagerServiceInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the serviceManagerServiceInfo property.
     * 
     * <p>
    ...
    public List<ServiceManagerServiceInfo> getServiceManagerServiceInfo() {
        if (serviceManagerServiceInfo == null) {
            serviceManagerServiceInfo = new ArrayList<ServiceManagerServiceInfo>();
        }
