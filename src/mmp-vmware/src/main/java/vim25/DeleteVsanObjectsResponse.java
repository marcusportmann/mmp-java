 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}HostVsanInternalSystemDeleteVsanObjectsResult" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    public List<HostVsanInternalSystemDeleteVsanObjectsResult> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<HostVsanInternalSystemDeleteVsanObjectsResult>();
        }
