...
@WebServiceClient(name = "SampleService", targetNamespace = "http://ws.sample.service.mmp.guru",
  wsdlLocation = "file:/Volumes/Data/Develop/MMP/mmp-java/src/mmp-sample/client/src/main" +
    "/resources/META-INF/wsdl/SampleService.wsdl")
  ...
  extends Service
{
  ...
  static
  {
    ...
    {
      url = new URL(
        "file:/Volumes/Data/Develop/MMP/mmp-java/src/mmp-sample/client/src/main/resources/META" +
          "-INF/wsdl/SampleService.wsdl");
    }
