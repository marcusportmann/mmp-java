...
/**
 * The <code>SampleWebApplication</code> provides the implementation of the Wicket Web
...
public class SampleWebApplication extends TemplateWebApplication
{
  ...
  {
    return new CssResourceReference(SampleWebApplication.class, "resources/css/application.css");
  }
