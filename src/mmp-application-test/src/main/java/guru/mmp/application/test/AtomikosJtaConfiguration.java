    ...
    synchronized (lock)
    {
      if (userTransaction == null)
      {
        try
        {
          ...
          userTransactionEnhancer.setCallback(new UserTransactionTracker(userTransactionManager()));

          userTransaction = (UserTransactionImp) userTransactionEnhancer.create();
    ...
    synchronized (lock)
    {
      if (userTransactionManager == null)
      {
        try
        {
          ...
          userTransactionManager = (UserTransactionManager) transactionManagerEnhancer.create();
