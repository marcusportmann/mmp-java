...
/**
 * The <code>ContainerManagedTransactionsExtension</code> class.
 *
 * @author Marcus Portmann
 */
public class ContainerManagedTransactionsExtension
  implements Extension
{
  ...
  public <T> void processAnnotatedType(@Observes ProcessAnnotatedType<T> processAnnotatedType)
  {
    ...
    Annotation annotation = () -> ContainerManagedTransactions.class;
