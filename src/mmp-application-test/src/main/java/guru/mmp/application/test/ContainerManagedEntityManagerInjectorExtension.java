...
/**
 * The <code>ContainerManagedEntityManagerInjectorExtension</code> class.
 *
 * See http://www.kumaranuj.com/2013/06/jpa-2-entitymanagers-transactions-and.html
 *
 * @author Marcus Portmann
 */
public class ContainerManagedEntityManagerInjectorExtension
  implements Extension
{
  ...
  public <T> void processAnnotatedType(@Observes ProcessAnnotatedType<T> processAnnotatedType)
  {
    ...
    Annotation annotation = () -> ContainerManagedEntityManager.class;
